...
// }
//
// Rect CalculateRectangleMBR(Node *n)  // Calculating the minimum bounding rectangle function
// {
//     Rect r_mbr;
//
...
//             {
//                 r_mbr.topRight.x = n->elements[i].mbr.topRight.x;  // assign the value if
//                                                                    // condition satisfies
//             }
//             else
//             {
//                 r_mbr.topRight.x = r_mbr.topRight.x;  // if condition doesn't satisfy ,it
//                                                       // remains unchanged
//             }
...
//     {
//         float minOverlap = -1.0;  // initialize minimum overlap value and index values and
//                                   // storing in float variable as overlap may be in decimal
//         int minIndex = -1;
//
//         for (int i = 0; i < node->count; i++)  // iterate through each entry of the node and calculate the
...
//
//             if (minOverlap < 0 || overlap <= minOverlap)  // update minimum overlap and index if overlap
